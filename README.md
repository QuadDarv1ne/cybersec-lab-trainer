...
Тренажёр содержит **8 обучающих модулей**, систему квизов с таймером, систему достижений, глоссарий терминов и набор интерактивных криптографических инструментов. Все материалы представлены на русском языке и опираются на актуальные стандарты безопасности, включая OWASP Top 10 (2021).
...
| **XSS-атаки** | 7 типов XSS (отражённый, хранимый, DOM-based, event-handler, SVG, data: URI, template injection) с интерактивной демонстрацией санитизации |
...
| **Безопасное кодирование** | 10 задач на ревью кода с поиском уязвимостей и предложениями по исправлению |
| **Инструменты** | Шифры Цезаря, Виженера, XOR; кодирование Base64/URL; хеширование; генератор паролей |
| **Заголовки безопасности** | Интерактивный модуль по HTTP-заголовкам безопасности: CSP, HSTS, X-Frame-Options и другие |

### Система тестирования

- **81 вопрос** по 8 категориям безопасности
- Таймер на 30 минут
